...
admin.initializeApp({
    credential: admin.credential.cert(path.resolve(__dirname, '../config/serviceAccountKey.json')),
});
var setCustomClaims = function (uid) { return __awaiter(_this, void 0, void 0, function () {
    var error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                console.error('Failed to set custom claims:', error_1);
                return [3 /*break*/, 3];
